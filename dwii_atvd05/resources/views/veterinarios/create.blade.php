...
@extends('templates.mainVet', ['titulo' => "Novo Veterinario"])
...
<form action="{{ route('veterinarios.store') }}" method="POST">
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <input type="especialidade" class="form-control" name="especialidade" placeholder="Especialidade" value="{{old('especialidade')}}" />
