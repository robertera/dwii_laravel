...
@extends('templates.mainVet', ['titulo' => "Alterar Veterinario"])
...
<form action="{{ route('veterinarios.update', $dados['id']) }}" method="POST">
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <input type="especialidade" class="form-control" name="especialidade" placeholder="Especialidade" value="{{$dados['especialidade']}}" />
